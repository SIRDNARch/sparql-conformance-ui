...
Use this for shared/public hosting.
...
- Expose `8080` publicly behind TLS reverse proxy.
- Restrict `3001` (uploader) by VPN, firewall allowlist, or internal network only.
